    ...
    if options["isRange"] == 0:
        ...
        if options["type"] == "tag":
            if options["get_what"] == "tag":
                ...
                get_text_list_of_tags(current_page, options["name"], options["attr"])
        elif options["type"] == "class":
            if options["get_what"] == "tag":
                target[options["label"]] = str(current_page.find_all(options["name"])[options["start"]:options["end"]])
            elif options["get_what"] == "attr":
                ...
                get_text_list_of_class(current_page, options["name"], options["attr"])
        elif options["type"] == "selector":
            if options["get_what"] == "tag":
                target[options["label"]] = str(current_page.find_all(options["name"])[options["start"]:options["end"]])
            elif options["get_what"] == "attr":
                ...
                get_text_list_of_selector(current_page, options["name"], options["attr"])
